...
select * from products where price=3.50 or coffee_origin='Colombia' or coffee_origin='Sri Lanka'; 
select * from products where price<=3.50 or price>=2.90; 
select * from customers;
select * from customers where phone_number is null;
select * from customers where phone_number is not null;

select first_name ,last_name,phone_number,gender from customers where last_name='Bluth' and gender='F';

select * from products where price>3.00 or coffee_origin='Sri Lanka';

select * from customers where phone_number is not null and gender='M';

select * from customers;

select * from products where price in (2.90,3.00,3.50);
select * from products where price not in (2.90,3.00,3.50);
...
select * from orders;
select * from orders where order_time between '2017-01-01' and '2017-01-08'; 
select * from orders where customer_id between 5 and 10; 
select * from customers where last_name between 'b' and 'j';
...
select name,price,coffee_origin from products where coffee_origin in ('Colombia','Indonesia') order by name;
...
select first_name, phone_number,last_name from customers where last_name like '%ar%' and gender='f';

select distinct coffee_origin from products;
select distinct customer_id,product_id  from orders where order_time between '2017-02-01' and '2017-02-28' order by customer_id;

select * from customers limit 5 offset 16;
select * from orders order by id  limit 5 offset 10;

select distinct last_name from customers order by last_name;
select * from orders where order_time between '2017-02-01' and '2017-02-28' and customer_id =1 limit 3;
select * from orders where order_time between '2017-02-01' and '2017-02-28' and customer_id =1 limit 3;
